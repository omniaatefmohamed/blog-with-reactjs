...
<div className="w3-col l8 s12">
  ...
  <div className="w3-card-4 w3-margin w3-white">
    <img src="images/woods.jpg" alt="Nature" style={{"width": "100%"}} loading="lazy"/>
  ...
  {/* <!-- Blog entry --> */}
  <div className="w3-card-4 w3-margin w3-white">
  <img src="images/bridge.jpg" alt="Norway" style={{"width":"100%"}} loading="lazy"/>
    <div className="w3-container">
...
<div className="w3-col l4">
  ...
  <img src="images/avatar_g.jpg" style={{"width":"100%"}} loading="lazy"/>
  ...
  <div className="w3-card w3-margin">
    ...
    <ul className="w3-ul w3-hoverable w3-white">
      <li className="w3-padding-16">
        <img src="images/workshop.jpg" alt="Image" className="w3-left w3-margin-right" style={{"width":"50px"}} loading="lazy"/>
        <span className="w3-large">Lorem</span><br />
        <span>Sed mattis nunc</span>
      </li>
      <li className="w3-padding-16">
        <img src="images/gondol.jpg" alt="Image" className="w3-left w3-margin-right" style={{"width":"50px"}} loading="lazy"/>
        <span className="w3-large">Ipsum</span><br />
        <span>Praes tinci sed</span>
      </li> 
      <li className="w3-padding-16">
        <img src="images/skies.jpg" alt="Image" className="w3-left w3-margin-right" style={{"width":"50px"}} loading="lazy"/>
        <span className="w3-large">Dorum</span><br />
        <span>Ultricies congue</span>
      </li>   
      <li className="w3-padding-16 w3-hide-medium w3-hide-small">
        <img src="images/rock.jpg" alt="Image" className="w3-left w3-margin-right" style={{"width":"50px"}} loading="lazy"/>
